CREATE DATABASE  IF NOT EXISTS `newschema` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `newschema`;
...
CREATE TABLE `food` (
  ...
  `Fats` double unsigned NOT NULL,
  `Carbonates` double unsigned NOT NULL,
  PRIMARY KEY (`FoodID`),
...
CREATE TABLE `normcpfc` (
  ...
  `DesiredWeight` double NOT NULL,
  `Calories` double unsigned NOT NULL,
  `Protein` double unsigned NOT NULL,
  `Fats` double unsigned NOT NULL,
  `Carbonatest` double unsigned NOT NULL,
  `UserID` int NOT NULL,
  PRIMARY KEY (`NormID`),
  KEY `UserID_idx` (`UserID`),
...
INSERT INTO `statisticcpfc` VALUES (1,'2024-01-15 09:00:00',6,6,6,6,1),(2,'2024-01-15 14:00:00',2380,130,62,285,1),(5,'2024-01-15 00:00:00',2850,145,75,320,3),(6,'2024-01-16 00:00:00',2780,140,72,315,3),(7,'2024-01-15 00:00:00',2150,105,60,265,4),(8,'2024-01-16 00:00:00',2200,110,62,270,4),(9,'2024-01-15 19:00:00',0,0,0,0,1),(14,'2025-11-22 00:00:00',1,1,1,1,38),(15,'2025-11-22 00:00:00',2,2,2,2,38),(16,'2025-11-22 00:00:00',3,3,3,3,38),(21,'2024-01-15 00:00:00',3,3,3,3,2),(22,'2025-11-26 00:00:00',1370,24,60,156,38),(23,'2024-01-16 00:00:00',2,2,2,2,2),(24,'2025-11-27 00:00:00',450,8,15,40,38);
...
-- Dump completed on 2025-12-08 22:21:33
