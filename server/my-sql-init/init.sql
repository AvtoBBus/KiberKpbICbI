CREATE DATABASE IF NOT EXISTS `newschema` 
...
GRANT ALL PRIVILEGES ON `newschema`.* 
TO 'fastapi_user'@'%';

-- Даем права на создание и управление временными таблицами
...
/*!50013 DEFINER=`fastapi_user`@`localhost` SQL SECURITY DEFINER */
...
-- Dump completed on 2025-12-08 22:36:56
